                ...
                <table class="listtable">
                    ...
                    <tr>
                        ...
                        <c:if test="${item.status.equals('0')}">
                            <a class="clickbutton" href="ViewMyBookingDetailServlet?meetingid=${item.meetingid}">查看/取消</a>
                       </c:if>
                         <c:if test="${item.status.equals('1')}">
                            <a class="clickbutton" href="ViewMyBookingDetailServlet?meetingid=${item.meetingid}">查看（已取消）</a>
                       </c:if>
                        </td>
                    </tr>
             </c:forEach>
